	...
	if(deviceName){
        ...
        switch(deviceType) {
        	case "switch":
				...
				def d = addChildDevice("ibeech", "Virtual Pi Relay", getRelayID(deviceConfig), null, [label:deviceName, name:deviceName])
            ...
            case "temperatureSensor":
                ...
                def d = addChildDevice("ibeech", "Virtual Pi Temperature", getTemperatureID(deviceConfig), null, [label:deviceName, name:deviceName])                 
